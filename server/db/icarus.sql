...
INSERT INTO orders (date, po_number, full_amount_raised, receipted_amount, tax_rate, requisitioner_id, supplier_id) VALUES ('2022/07/06', 155, 1300, 1000, 20, 3, 8);
INSERT INTO orders (date, po_number, full_amount_raised, receipted_amount, tax_rate, requisitioner_id, supplier_id) VALUES ('2022/07/06', 155, 1300, 1000, 20, 3, 4);
INSERT INTO orders (date, po_number, full_amount_raised, receipted_amount, tax_rate, requisitioner_id, supplier_id) VALUES ('2022/07/06', 155, 1300, 1000, 20, 3, 2);
INSERT INTO orders (date, po_number, full_amount_raised, receipted_amount, tax_rate, requisitioner_id, supplier_id) VALUES ('2022/07/06', 155, 1300, 1000, 20, 3, 1);
INSERT INTO orders (date, po_number, full_amount_raised, receipted_amount, tax_rate, requisitioner_id, supplier_id) VALUES ('2022/07/06', 155, 1300, 1000, 20, 3, 10);
INSERT INTO orders (date, po_number, full_amount_raised, receipted_amount, tax_rate, requisitioner_id, supplier_id) VALUES ('2022/07/06', 155, 1300, 1000, 20, 3, 12);
